...
import fr.javafx.scene.control.chart.axis.LogarithmicAxis;
...
public class LogarithmicAxisSample extends AbstractSamplePane {
	...
	public Node createSamplePane() {
		...
		chartPane.getPlugins().addAll(new XYChartZoomer(), new XYChartPanner(), new DataPointTooltip(), new CrosshairIndicator<>());
