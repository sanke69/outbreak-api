...
public class OutbreakReportBeanFx implements Outbreak.LocalizedReport {
	private ObjectProperty<KpiType>  	  type			= new SimpleObjectProperty<KpiType>();
...
//	private ObjectProperty<GeoCoordinate> coordinate	= new SimpleObjectProperty<GeoCoordinate>();
	...
	public OutbreakReportBeanFx(Outbreak.LocalizedReport _record) {
		this();
	...
	public void 								setType(KpiType _type) 			{ type.set(_type); }
	@Override public KpiType	 				getType() 						{ return type.get(); }
	public ReadOnlyObjectProperty<KpiType>  	typeProperty() 					{ return type; }
