...
public class OutbreakSeries {
	...
	public OutbreakSeries(String _name, Collection<? extends Outbreak.ReferencedReport> _reports) {
		this(_name, _reports, false, 0);
	}
	public OutbreakSeries(String _name, Collection<? extends Outbreak.ReferencedReport> _reports, boolean _dayNormalization) {
		this(_name, _reports, _dayNormalization, 0);
	}
	public OutbreakSeries(String _name, Collection<? extends Outbreak.ReferencedReport> _reports, boolean _dayNormalization, int _dayShift) {
		super();
	...
	public XYChart.Series<Number,Number> getData			(String _name, Outbreak.Population _population, boolean _dayNormalization, int _dayShift) {
		...
		for(Outbreak.ReferencedReport orr : reports) {
